...
These two ways of working probably sound very familiar. At least they were for me. For example, I often found myself replying to e-mails or Slack messages after being in a boring meeting for a while. Recognizing this distinction is the first step towards eliminating distracting and shallow behavior. Why is this useful? Or rather: why do we want to focus on deep work? This becomes clear when looking at Newport's hypothesis regarding the relevance of deep work:
